...
<body>
	...
	<div class="container clearfix">
		...
		<div class="secondary col">
			...
			<p><?php echo $Mensaje_largo; ?></p>
			<p><?php echo $Mensaje_largo2; ?></p>
		...
		<div class="primary col">
			...
			<p><?php echo $Mensaje_largo3; ?></p>
		</div><!--/.primary-->
		<div class="tertiary col">
			<h2>Nosotros</h2>
			<p><strong><?php echo $Mensaje_largo4; ?><strong></p>
